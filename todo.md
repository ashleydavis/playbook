...
- I still need planning!
    ...
    - I really just need to use my existing plan skills, but need a new skill to convert a plan to work items.
- Review doesn't need to run compile or automated tests if there are no code or configuraton 
changes.
