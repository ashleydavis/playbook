...
**Failures:** 0
**Priority:** 100
**Platforms:** <comma-separated platforms this ticket may be worked on (linux, darwin, win32), or remove this line if any>
...
- **Platforms:** optional. Locks the ticket to the listed platforms (Node's process.platform names: linux, darwin, win32). next-tickets.ts admits a locked ticket to in-progress only on one of those platforms. Absent means any platform. Set or clear it with set-platforms.ts (pb:platforms).
