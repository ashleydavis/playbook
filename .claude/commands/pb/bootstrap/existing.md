...
7. Populate `state/current-state.md` to reflect where things stand (existing in-flight work, recent commits, known issues, and whether the test suite is currently green).
